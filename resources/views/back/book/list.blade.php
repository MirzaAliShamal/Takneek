...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Total {{ $count }} Books	</span>
        </h3>
...
<script>
    var options = {
                ...
                return ''+
                    '<div class="d-flex align-items-center">'+
                        ...
                        '<div class="ml-4">'+
                            ...
                            '<div class="text-muted font-weight-bold">'+row.book_category.name+'</div>'+
                        '</div>'+
                    '</div>';
        ...
        },
        {
            ...
            template: function(row) {
                return ''+
                    '<a href="'+base_url+'/books/edit/'+row.id+'" class="btn btn-sm btn-clean btn-icon mr-2 edit-item" title="Edit details">'+
                        ...
                        '</span>'+
                    '</a>'+
                    '<a href="'+base_url+'/books/delete/'+row.id+'" class="btn btn-sm btn-clean btn-icon delete-item" title="Delete">'+
                        '<span class="svg-icon svg-icon-md">'+
                            '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">'+
                                '<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">'+
                                    '<rect x="0" y="0" width="24" height="24"/>'+
