        ...
        <!--begin::Form-->
        <form class="space_form" id="space_form"  action="{{ route('book.save') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <button type="submit" class="btn btn-primary mr-2 save btn-block">Add Book</button>
                    </div>
                </div>
            </div>
        </form>
