...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">All Post Categories</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Total {{ $count }} Post Categories	</span>
        </h3>
        <div class="card-toolbar">
            <a href="{{ route('post.category.add') }}" class="btn btn-primary font-weight-bolder font-size-sm" id="modal_toggle">
    ...
    var options = {
        ...
        columns: [{
            ...
            template: function(row) {
                return ''+
                    '<a href="'+base_url+'/post-categories/edit/'+row.id+'" class="btn btn-sm btn-clean btn-icon mr-2 edit-item" title="Edit details">'+
                        ...
                        '</span>'+
                    '</a>'+
                    '<a href="'+base_url+'/post-categories/delete/'+row.id+'" class="btn btn-sm btn-clean btn-icon delete-item" title="Delete">'+
                        '<span class="svg-icon svg-icon-md">'+
                            '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">'+
                                '<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">'+
                                    '<rect x="0" y="0" width="24" height="24"/>'+
