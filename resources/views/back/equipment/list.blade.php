...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">All Equipments</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm">Total {{ count($list) }} Equipments	</span>
        </h3>
        <div class="card-toolbar">
            <a href="{{ route('equipment.add') }}" class="btn btn-primary font-weight-bolder font-size-sm" id="modal_toggle">
            ...
            <table class="table table-head-custom table-vertical-center table-head-bg table-borderless" id="kt_advance_table_widget_3">
                <thead>
                    <tr class="text-center text-uppercase">
                        ...
                        <th class="px-0 text-left" style="min-width:250px;">Equipment</th>
                ...
                <tbody id="mybody">
                    ...
                    <tr>
                        ...
                        <td class="text-right pr-0">
                            <a href="{{ route('equipment.edit', $item->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-item" data-toggle="tooltip" data-theme="dark" title="Edit">
