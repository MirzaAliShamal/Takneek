            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{ route('booking.list') }}" class="menu-link menu-toggle">
                        ...
                        <span class="menu-label">
                            <span class="label label-rounded label-primary" data-toggle="tooltip" title="Booked">8600</span>
                        </span>
                        <span class="menu-label">
                            <span class="label label-rounded label-primary"data-toggle="tooltip" title="Vacent">615</span>
                        </span>

                    </a>
                </li>
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{ route('event.list') }}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-label">
                            <span class="label label-rounded label-primary"data-toggle="tooltip" title="Seat Booked">308</span>
                        </span>
                        <span class="menu-label">
                            <span class="label label-rounded label-primary"data-toggle="tooltip" title="Seat Vacent">250</span>
                        </span>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Inquires</span>
                        <span class="menu-label">
                            <span class="label label-rounded label-primary"data-toggle="tooltip" title="Action Pending">6</span>
                        </span>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                        ...
                        <span class="menu-label">
                            <span class="label label-rounded label-primary"data-toggle="tooltip" title="Request">15</span>
                        </span>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="##" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Co-Working</span>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="" class="menu-link">
                                    ...
                                    <span class="menu-text">Bookings</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-primary">60</span>
                                    </span>
                                </a>
                            </li>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/header-dark.html" class="menu-link">
                                    ...
                                    <span class="menu-label">
                                        <span class="label label-rounded label-primary">8600</span>
                                    </span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="http://localhost/km/index.php?page=report" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x">
                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Book-open.svg-->
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/subheader/tabbed.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Users</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-primary">56</span>
                                    </span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/general/minimized-aside.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Bookings</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-primary">30</span>
                                    </span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{ route('post.category.list') }}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">Post Categories</span>
                        <span class="menu-label">
                            <span class="label label-rounded label-primary"data-toggle="tooltip" title="Seat Vacent">250</span>
                        </span>
                    </a>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{ route('post.list') }}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{ route('manage.permission') }}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon svg-icon-primary svg-icon-2x">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="menu-text">Manage Role Permission</span>
                        {{-- <i class="menu-arrow"></i> --}}
                    </a>
                </li>
                <li class="menu-section">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/general/minimized-aside.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Expences</span>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/general/no-aside.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Income Vs Expence</span>
