                ...
                <tbody>
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td class="pl-0">
                                <div class="symbol symbol-50 symbol-light mt-1">
																<span class="symbol-label">
																	<img src="{{asset($item->first_img)}}" class="h-75 align-self-end" alt="" />
																</span>
                                </div>
                            </td>
                            <td class="pl-0">
                            ...
                            <td>
                                <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$item->location}}</span>

                            </td>
                            <td class="text-center">
                                @if($item->recurring_appointment=='week')
                                    <span class="label label-lg label-light-warning label-inline">Weekly</span>
                                @elseif($item->recurring_appointment=='daily')
                                    <span class="label label-lg label-light-success label-inline">Daily</span>
                                @elseif($item->recurring_appointment=='monthly')
