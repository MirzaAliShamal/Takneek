<html>
    <head>
        ...
        <style>
            ...
            .offcanvas.offcanvas-right.offcanvas-on {
                -webkit-transition: left 0.6s ease, right 0.6s ease, bottom 0.6s ease, top 0.6s ease;
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed subheader-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <!--begin::Main-->
        @include('back.components.header_mobile')
        ...
        <div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
                ...
                <!--begin::Aside-->
				@include('back.components.sidenav')
                <!--end::Aside-->
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <!--begin::Subheader-->
						{{-- @include('back.components.sub_header') --}}
                        <!--end::Subheader-->
        ...
        <script>
            ...
            $(document).on("click", "#kt_demo_panel_close", function(e) {
            ...
            $(document).on("submit", "#space_form", function(e) {
                e.preventDefault();
                let form = $(this);
            ...
            function draggable() {
                var containers = document.querySelectorAll('.draggable-area');
