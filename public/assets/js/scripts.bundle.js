...
KTUtil.ready(function() {
    ...
    if (typeof KTLayoutDemoPanel1 !== 'undefined') {
...
var KTLayoutDemoPanel1 = function() {
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_demo_panel1_close',
            toggleBy: 'kt_demo_panel1_toggle'
        });
        ...
        if (typeof offcanvas !== 'undefined' && offcanvas.length === 0) {
            offcanvas.on('hide', function() {
                var expires = new Date(new Date().getTime() + 60 * 60 * 1000); // expire in 60 minutes from now
                KTCookie.setCookie('kt_demo_panel1_shown', 1, {expires: expires});
            });
        }
    }
    ...
    var _remind = function() {
        ...
        setTimeout(function() {
            if (!KTCookie.getCookie('kt_demo_panel1_shown')) {
                var expires = new Date(new Date().getTime() + 15 * 60 * 1000); // expire in 15 minutes from now
                KTCookie.setCookie('kt_demo_panel1_shown', 1, { expires: expires });
                if (typeof _offcanvasObject !== 'undefined') {
                    _offcanvasObject.show();
